...
// Single responsibility principle example, The Survey struct is just responsible for Survey Related data
// so the SaveSurvey method should not be a part of it
...
// "O" Principle example. ExportSurvey is now closed to modification but can be extended easily because it accepts
// an interface whose Export() method can be implemented in different ways.
